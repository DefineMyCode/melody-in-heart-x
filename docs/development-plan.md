...
| 4 | `:core:ui` | `cn.com.dcsgo.mihx.core.ui` | 公共 Compose：主题、ToastHost、LyricsView、通用组件 | `theme/MelodyTheme.kt`、`theme/{Color,Type,Shape}.kt`、`toast/ToastHost.kt`、`toast/ToastController.kt`、`toast/ToastMessage.kt`、`lyrics/LyricsView.kt`、`component/{SongRow,SeekSlider,EmptyState,PermissionRationaleDialog}.kt` |
