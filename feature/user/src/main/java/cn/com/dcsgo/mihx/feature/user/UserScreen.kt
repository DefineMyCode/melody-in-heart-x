...
fun UserScreen(
    ...
    // key 的顺序：user_info(0), file_mgmt(1), local_header(2), [search_box(3)], song_0, song_1, ...
            ...
            if (localSongs.isEmpty()) {
                ...
                items(
                    ...
                    LocalSongItem(
                        ...
                        onShowInfo = { songForInfo = song },
                        onAddToPlaylist = { songForSinglePlaylist = song },
...
@Composable
private fun SearchEmptyHint(searchQuery: String) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .defaultMinSize(minHeight = 400.dp)
